...
function setupModals() {
    ...
    if (cartBtn && cartModal && closeCart && checkoutBtn) {
    ...
    if (checkoutBtn && checkoutModal && closeCheckout && checkoutMessage) {
...
// --- Animationen: Flammen und Blätter ---
function setupAnimations() {
    // Flammen-Animation (Dummy, kann erweitert werden)
    // ...hier kann die Flammenanimation wie vorher eingefügt werden...

    // Blätter-Animation (Dummy, kann erweitert werden)
